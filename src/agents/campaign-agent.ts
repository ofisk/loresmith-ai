...
- FIRST call getPlanningTaskProgress (scoped to the upcoming session by default). If there are open (pending/in_progress) tasks for that session, return those immediately and tell the user they can view and manage them in Campaign Details under the Next steps tab—do not generate new tasks.
