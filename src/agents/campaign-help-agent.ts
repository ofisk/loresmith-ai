...
const CAMPAIGN_HELP_SYSTEM_PROMPT = buildSystemPrompt({
	...
	workflowGuidelines: [
		...
		"Handle Specialist Work Yourself: When users ask for specific campaign management or world state updates, call askAnotherAgent to get it done and report the result as your own. Never tell them to rephrase, to use a different prompt, or to ask somewhere else",
	],
	importantNotes: [
