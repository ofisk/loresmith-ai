...
function resolveFromContext(ctx: AppShellContextValue) {
	return {
		...
		isDesktopSidebarCollapsed: ctx.isDesktopSidebarCollapsed,
		onToggleDesktopSidebarCollapse: ctx.onToggleDesktopSidebarCollapse,
...
function resolveFromProps(
	...
	return {
		...
		onToggleDesktopSidebarCollapse: noop,
		visibleShardGroups,
		shardsLoading: false,
