					...
					<div className="flex gap-4 flex-wrap">
						{hasNoCampaigns && onCreateCampaign && (
							<button
								...
								className="flex-1 min-w-[200px] bg-white/80 dark:bg-neutral-800/80 p-5 rounded-xl border-2 border-neutral-300 dark:border-neutral-600 backdrop-blur-sm shadow-sm hover:shadow-md hover:bg-white dark:hover:bg-neutral-800 transition-colors transition-shadow cursor-pointer text-left"
						...
						<button
							...
							className="flex-1 min-w-[200px] bg-white/80 dark:bg-neutral-800/80 p-5 rounded-xl border border-neutral-200/50 dark:border-neutral-700/50 backdrop-blur-sm shadow-sm hover:shadow-md hover:bg-white dark:hover:bg-neutral-800 transition-colors transition-shadow cursor-pointer text-left"
						...
						<button
							...
							className="flex-1 bg-white/80 dark:bg-neutral-800/80 p-5 rounded-xl border border-neutral-200/50 dark:border-neutral-700/50 backdrop-blur-sm shadow-sm hover:shadow-md hover:bg-white dark:hover:bg-neutral-800 transition-colors transition-shadow cursor-pointer text-left"
