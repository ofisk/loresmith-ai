...
if [ ! -f ".dev.vars" ]; then
    ...
    echo "  - ADMIN_SECRET"
    echo "  - OPENAI_API_KEY"
    echo "  - AUTORAG_API_TOKEN (set as secret)"
    echo ""
...
echo "2. Set up your AutoRAG API token: wrangler secret put AUTORAG_API_TOKEN --config wrangler.dev.jsonc"
echo "3. Create your AutoRAG instance in the Cloudflare dashboard"
