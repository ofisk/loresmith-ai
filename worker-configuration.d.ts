/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d24ed07e3b0e39b138158c001d8d3bb5)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "ADMIN_SECRET" | "VITE_API_URL" | "CORS_ALLOWED_ORIGINS">> {}
}
...
declare class DOMException extends Error {
    ...
    // biome-ignore lint/suspicious/noExplicitAny: TypeScript definition file
    get stack(): any;
    // biome-ignore lint/suspicious/noExplicitAny: TypeScript definition file
    set stack(value: any);
}
...
declare namespace WebAssembly {
    ...
    class Table {
        constructor(descriptor: TableDescriptor, value?: unknown);
...
interface ServiceWorkerGlobalScope extends WorkerGlobalScope {
    ...
    setTimeout(callback: (...args: unknown[]) => void, msDelay?: number): number;
    setTimeout<Args extends unknown[]>(callback: (...args: Args) => void, msDelay?: number, ...args: Args): number;
    clearTimeout(timeoutId: number | null): void;
    setInterval(callback: (...args: unknown[]) => void, msDelay?: number): number;
    setInterval<Args extends unknown[]>(callback: (...args: Args) => void, msDelay?: number, ...args: Args): number;
...
declare function setTimeout(callback: (...args: unknown[]) => void, msDelay?: number): number;
/* [MDN Reference](https://developer.mozilla.org/docs/Web/API/Window/setTimeout) */
declare function setTimeout<Args extends unknown[]>(callback: (...args: Args) => void, msDelay?: number, ...args: Args): number;
/* [MDN Reference](https://developer.mozilla.org/docs/Web/API/Window/clearTimeout) */
declare function clearTimeout(timeoutId: number | null): void;
/* [MDN Reference](https://developer.mozilla.org/docs/Web/API/Window/setInterval) */
declare function setInterval(callback: (...args: unknown[]) => void, msDelay?: number): number;
/* [MDN Reference](https://developer.mozilla.org/docs/Web/API/Window/setInterval) */
declare function setInterval<Args extends unknown[]>(callback: (...args: Args) => void, msDelay?: number, ...args: Args): number;
...
// biome-ignore lint/suspicious/noExplicitAny: Generated type definitions
