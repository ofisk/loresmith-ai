/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5a7c66823c561f280fac5695aab87869)
// Runtime types generated with workerd@1.20260721.1 2025-05-07 nodejs_compat,nodejs_compat_populate_process_env
interface __BaseEnv_Env {
	...
	APP_ORIGIN: "https://loresmith.ai";
	VERIFICATION_EMAIL_FROM: "LoreSmith <support@loresmith.ai>";
	CORS_ALLOWED_ORIGINS: "https://loresmith.ai,https://www.loresmith.ai,https://loresmith-ai-dev.oren-t-fisk.workers.dev";
	CHAT: DurableObjectNamespace<import("./src/server").Chat>;
	UPLOAD_SESSION: DurableObjectNamespace<import("./src/server").UploadSessionDO>;
	NOTIFICATIONS: DurableObjectNamespace<import("./src/server").NotificationHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "Chat" | "UploadSessionDO" | "NotificationHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LORESMITH_VERBOSE_LLM_USAGE" | "MAX_INDEX_FILE_BYTES" | "STAGING_PREFIX" | "READINESS_TIMEOUT_SEC" | "READINESS_BACKOFF_MS" | "PRODUCTION_URL" | "APP_ORIGIN" | "VERIFICATION_EMAIL_FROM" | "CORS_ALLOWED_ORIGINS">> {}
}
